<template>
    <div class="home" v-cloak>
        ...
        <div class="ctn food-box">
            ...
            <div v-if="foodDetailsData.material">
            <template v-if="foodDetailsData.material.majorMaterialList && foodDetailsData.material.majorMaterialList.length">
                ...
                <div class="foodlist">
                    <div class="foodlist-cont" @click="goToInfo(item)" v-for="(item,i) in foodDetailsData.material.majorMaterialList" :key="i">
                        ...
                        <p>{{item.count*10/10}}{{item.unit}}</p>
                    </div>
                </div>
            </template>
            </div>
    ...
    export default {
        ...
        methods: {
            async loadData () {
                ...
                const data = await apiFoodDetails(this.code,this.userInfo.userId,this.foodId,this.mealType)
