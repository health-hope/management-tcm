<template>
    <div class="detail" v-if="executeList.dataList && executeList.dataList.length">
        <div class="ctn">
            <LayBg/>
            <ul>
                <li class="b2" v-for="(item, i) in executeList.dataList" :key="`li${i}`">
                    <div class="title">
...
<script>
    ...
    import { apiGetList, apiEnd } from '@/service/api/conditionMotion'
    ...
    export default {
        ...
        computed: {
            ...mapState(['code', 'userInfo', 'listObj', 'startTime']),
        },
        filters: {
            datefilter(val) {
