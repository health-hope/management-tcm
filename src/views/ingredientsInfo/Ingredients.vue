    ...
    <div class="home">
        ...
        <div class="ctn food-box">
            ...
            <template v-if="infoData.efficacys[0]">
                ...
                <div class="cont">{{infoData.efficacys[0]}}</div>
            </template>
            <template >
                <h3 class="food-tit">
                ...
                <div class="cont">{{infoData.taboos[0]?infoData.taboos[0]:"无"}}</div>
            </template>
    ...
    methods: {
        getBrief() {
            ...
            if(this.$route.query.foodId){
                ...
                getIngredientsInfo(this.userInfo.userId,foodId,this.code,type).then(res => {
                    this.infoData = res;
...
.home {
    ...
    .food-box {
        ...
        .cont {
            @include border2(.025rem /* 1/40 */ solid);
